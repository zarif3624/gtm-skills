...
Transfer the truth of the deal, not just the contract record. Help the receiving team deliver the outcomes the customer believes they bought.

## Inputs

Read `.agents/gtm-context.md`, contract or order scope, final proposal, discovery and technical notes, stakeholder map, mutual action plan, and relevant correspondence. Minimize personal data and follow access restrictions.

## Workflow

1. Confirm the contracted products, services, term, commercial boundaries, and authoritative source.
2. Capture the customer's desired outcomes, measures, timeline, and evidence.
3. List every commitment, expectation, concession, roadmap discussion, workaround, and open question.
...
- Never convert an unapproved promise into a committed deliverable.
...
- contracted scope and authoritative sources;
- desired outcomes and success measures;
- stakeholder map;
- commitments and expectation gaps;
