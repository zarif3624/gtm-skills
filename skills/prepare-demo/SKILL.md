...
1. Define the decision or learning the demo should enable.
2. List the buyer outcomes and evidence captured in discovery.
3. Map each outcome to the smallest product moment that can demonstrate it.
4. Remove features that do not support the decision.
