...
Create a shared path to a sound decision. The plan belongs to the buyer and seller together; it is not a disguised pressure device.

## Preconditions

Read `.agents/gtm-context.md`, qualification, the deal plan, and known buyer dates. Confirm that the buyer sees value in a plan and has participated in defining the decision path. If not, create a draft explicitly labeled for buyer review.
...
- shared outcome and success criteria;
- verified target date and business reason, or `Unknown`;
- milestones with owners, dates, evidence of completion, and status;
...
- Never fabricate buyer agreement, owners, deadlines, or completed steps.
- Do not call a unilateral seller plan mutual.
