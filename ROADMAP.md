...
The repository now has 21 focused skills, one isolated adversarial case per skill, eight cross-skill journey cases, a contrastive routing corpus, a dependency-free validation suite, a validated fictional workspace, and a schema for reproducible forward-test reports. This establishes the quality foundation; it does not imply that every model or agent passes every behavioral case.
