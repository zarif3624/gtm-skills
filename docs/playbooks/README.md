...
Skill sequences for the eleven roles that use this project most. Each playbook is a first-week plan: which skills to install, what to feed them, what artifact to expect at each step, and where the evidence rules protect you.

| You are | Start here |
| --- | --- |
| A founder doing founder-led sales | [Founder playbook](founder.md) |
| An account executive carrying a quota | [Account executive playbook](account-executive.md) |
...
| A demand generation leader turning acquisition activity into inspectable learning | [Demand Generation leader playbook](demand-generation.md) |
...
Not sure which playbook fits? Start with the [ten-minute quickstart](../../QUICKSTART.md) instead, or grab a single prompt from the [prompt cookbook](../prompt-cookbook.md).
