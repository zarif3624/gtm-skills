...
| OpenAI Codex clean-context subagent | The latest self-contained blind packet exposed only installed names and descriptions; the evaluator selected the exact intended minimal set for 28/28 routing requests with zero excluded neighbors | Twenty-one latest recorded behavioral scenarios pass, spanning forecasting, source safety, coaching, outcomes, business cases, sales process, positioning, outbound handoff, qualification, customer handoff, negotiation, demos, mutual plans, account identity, ICP scoreability, prospecting privacy, deal planning, discovery verification, and territory capacity; exact model identifier was unavailable | Limited positive evidence for the recorded lineage and commits; see [behavior history](../evals/results/) and [routing evidence](../evals/routing/results/) |
